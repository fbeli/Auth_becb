...
function gerarToken_direto(){
    let clientAuth = btoa(config.clientId_token + ":" + config.clientSecret);

    let params = new URLSearchParams();
    params.append("grant_type", "password");
    params.append("username", config.const_username);
    params.append("password", config.const_password);
...
$("#btn-login-get-token").click(gerarToken_direto);
$("#consultar_token").click(consultar_com_token);
